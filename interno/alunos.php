	...
	<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
		<header class="mdl-layout__header">
			<div class="mdl-layout__header-row">
				<h1 class="mdl-layout-title">Alunos</h1>
		...
		<main class="conteudo-al mdl-layout__content">
			<div class="mdl-grid">
				<div class="col mdl-cell mdl-cell--2-col mdl-cell--4-col-phone mdl-cell--8-col-tablet">
					...
					<table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp">
						...
						<tbody>
						<?php while($i = $alunos->fetch()){ ?>
						 	<?php $cont += 1; ?>
							<tr>
						    	<td class="mdl-data-table__cell--non-numeric"><?php echo $i['nome']; ?></td>
						    	<td><a href="novoAluno.php?edit=<?php echo $i['id'] + 82789;?>">Editar</a></td>
						    	<td><a href="../controller/ConAluno.php?delete=<?php echo $i['id'] + 82789; ?>">Excluir</a></td>
						 	</tr>
						<?php } ?>
							<h5><?php echo $cont, " - alunos"; ?></h5>
 						</tbody>
					</table>
